/*! grapesjs-tooltip - 0.1.5 */ ! function (t, e) {
    ...
    return function (t) {
        ...
        e.default = function (t) {
            ...
            (0, r.default)(t, n), (0, a.default)(t, n)
        }
    }, function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", {
        ...
        e.default = function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                ...
                T = p + "-pos",
                O = p + "-length";
            b && t.SelectorManager.getAll().add([{
                private: 1,
                name: d
            }, {
                private: 1,
                ...
                private: 1,
                name: x
            }]), v && t.on("styleManager:update:target", function (e) {
                var n = t.getSelected();
                if (n) {
                    var o = n.getEl();
                    n.is(s) && !n.getTrait(w).getTargetValue() && e.getSelectors().getFullString().trim() == "." + y && (o.setAttribute(w, "true"), t.once("styleManager:update:target", function () {
                        o.removeAttribute(w)
                    }))
                }
            });
            n.addType(s, {
                model: a.extend({
                    defaults: o({}, a.prototype.defaults, {
                        ...
                        traits: h([{
                            ...
                            command: function (t, e) {
                                var n = t.Panels.getButton("views", "open-sm");
                                n && n.set("active", 1), t.StyleManager.setTarget("." + y, {
                                    targetIsClass: 1,
                                    stylable: g
                                })
                            }
                    ...
                    checkEmpty: function () {
                        this[!this.components().length ? "addClass" : "removeClass"]("" + x)
                    }
                }, {
                    isComponent: function (t) {
                        if (t.hasAttribute && t.hasAttribute(p)) return {
                            type: s
                        }
                    }
                }),
