...
@section('subcontent')
 <div class="new_tabs_start my-3">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Contact List</button>
  </li>

  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-ecl-tab" data-toggle="pill" data-target="#pills-ecl" type="button" role="tab" aria-controls="pills-ecl" aria-selected="true">Email Contact List</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-pcl-tab" data-toggle="pill" data-target="#pills-pcl" type="button" role="tab" aria-controls="pills-pcl" aria-selected="true">Phone Contact List</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-bulk-imexp-tab" data-toggle="pill" data-target="#pills-bulk-imexp" type="button" role="tab" aria-controls="pills-bulk-imexp" aria-selected="true">Bulk Import/Export</button>
  </li>
