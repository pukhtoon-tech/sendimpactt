...
@section('subcontent')
 <div class="new_tabs_start my-3">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Group List</button>
  </li>

  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-ang-tab" data-toggle="pill" data-target="#pills-ang" type="button" role="tab" aria-controls="pills-ang" aria-selected="true">Add Group</button>
  </li>
  
</ul>
<div class="tab-content" id="pills-tabContent">

@include('group.components.group-list-content')      
@include('group.components.add-group-content')      
