...
@section('subhead')
    <title>@translate(Template Builder)</title>
...
@section('subcontent')
 <div class="new_tabs_start my-3">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active" id="pills-home-tab" data-toggle="pill" data-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Email Template</button>
  </li>

  <li class="nav-item" role="presentation">
    <button class="nav-link" id="pills-sms-template-tab" data-toggle="pill" data-target="#pills-sms-template" type="button" role="tab" aria-controls="pills-sms-template" aria-selected="true">SMS Template</button>
  </li>
  
</ul>
<div class="tab-content" id="pills-tabContent">

  @include('template_builder.components.email-content')  
  @include('template_builder.components.sms-content')    
