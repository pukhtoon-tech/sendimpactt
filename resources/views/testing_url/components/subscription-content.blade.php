                    ...
                    @foreach (subscriptions('free') as $free)
                        ...
                        <div class="flex-1">
                            <div class="intro-y flex-1 box py-16 lg:ml-5 mb-5 lg:mb-0">
                               ...
                               <a href="{{ route('subscription_plan.index' , $free->id) }}"
                    ...
                    @foreach (subscriptions('monthly') as $monthly)
                        ...
                        <div class="flex-1">
                            <div class="intro-y flex-1 box py-16 lg:ml-5 mb-5 lg:mb-0">
                                ...
                                <a href="{{ route('subscription_plan.index', $monthly->id) }}"
                    ...
                    @foreach (subscriptions('yearly') as $yearly)
                        ...
                        <div class="flex-1">
                            <div class="intro-y flex-1 box py-16 lg:ml-5 mb-5 lg:mb-0">
                                ...
                                <a href="{{ route('subscription_plan.index' , $yearly->id) }}"
...
@include('testing_url.modals.create')