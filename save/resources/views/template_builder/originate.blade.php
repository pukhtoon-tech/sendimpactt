            ...
            <form action="{{ route('template.builder.originate.create') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="text-right mt-5">
                        <button type="submit" class="button w-50 bg-theme-1 text-white" name="editor" value="classic">@translate(Enter To Classic Editor)</button>
                        <button type="submit" class="button w-50 bg-theme-1 text-white" name="editor" value="pro">@translate(Enter To Pro Editor)</button>
                    </div>
                </div>
            </form>
            <!-- END: Form Layout -->
