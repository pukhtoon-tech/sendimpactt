        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
            ...
            <div class="w-full sm:w-auto ml-2 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="text-right relative text-gray-700 dark:text-gray-300">
                    <input type="text" id="groupIndex" class="input lg:w-56 mt-5 lg:mt-0 w-full box pr-10 placeholder-theme-13 tooltip" title="@translate(Search)" placeholder="Search...">
