        ...
        <div class="dropdown-box w-56">
            <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                ...
                <div class="p-2">
                    ...
                    <a href="{{ route('app.api.index') }}" class="hidden flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                        <i data-feather="lock" class="w-4 h-4 mr-2"></i> @translate(API Integration)
                    </a>
                    ...
                    @can('Admin')
                        ...
                        <a href="https://youtube.com/playlist?list=PLPqwPhMH_hborEIPb4nGWWNEdOQz2k6ml" target="_blank" class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                            <i data-feather="help-circle" class="w-4 h-4 mr-2"></i> @translate(Tutorial)
                        </a>
