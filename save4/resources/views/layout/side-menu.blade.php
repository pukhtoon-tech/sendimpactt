        ...
        <ul class="hidden">
            ...
            <li>
                <a href="{{ route('marketplace.index') }}"
                    ...
                    <div class="{{ request()->routeIs('marketplace.*') ? 'mldl-active-menu' : 'flex items-center' }}">
                        <div class="side-menu__icon">
            ...
            <li>
                <a href="javascript:;" class="side-menu {{
                        request()->routeIs('twilio.voice.*') ? 'side-menu--active side-menu--open' : ''
                    }}">
                    <div class="{{ request()->routeIs('twilio.voice.*') ? 'mldl-active-menu' : 'flex items-center' }}">
                        <div class="side-menu__icon">
                ...
                <ul class="d-none {{
                        request()->routeIs('twilio.voice.*') ? 'side-menu__sub-open' : ''
                    }}">
                    <li>
                ...
                <li>
                    <a href="{{ isset($menu['route_name']) ? route($menu['route_name'], $menu['params']) : 'javascript:;' }}"
                        ...
                        @if(isset($menu['route_name']))
                            {{ request()->routeIs($menu['route_name']) ? 'side-menu--active side-menu--open' : '' }}
                        @endif">
                        <div class="@if(isset($menu['route_name']))
                                {{ request()->routeIs($menu['route_name']) ? 'mldl-active-menu' : 'flex items-center' }}
                            @else
                                flex items-center
                            @endif">
                            ...
                            <li>
                                <a href="{{ isset($subMenu['route_name']) ? route($subMenu['route_name'], $subMenu['params']) : 'javascript:;' }}"
                                    ...
                                    @if(isset($subMenu['route_name']))
                                        {{ request()->routeIs($subMenu['route_name']) ? 'side-menu--active' : '' }}
                                    @endif">
